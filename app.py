...
CATEGORIES_TO_SCRAPE = [
    {"url": "https://freeporno.xxx/schoolgirl", "name": "schoolgirl", "filename": "db.json"},
    {"url": "https://freeporno.xxx/18-19-year-old", "name": "18-19-year-old", "filename": "db2.json"},
    {"url": "https://freeporno.xxx/tied-up", "name": "tied-up", "filename": "db3.json"}
]
